...
if __name__ == '__main__':
    ...
    weeksIncrement = 6
    startRangeTest = datetime.datetime(2021,1,14,0,0,0)
    endRangeTest = datetime.datetime(2022,8,19,0,0,0)
    ...
    while currentLowerRangeTest < endRangeTest:
        ...
        testPriceRelativeVectorsFull.append([priceRelativeVector for priceRelativeVector in testPriceRelativeVectors])
